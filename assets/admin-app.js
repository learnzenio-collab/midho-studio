...
async function enter(){
  ...
  try{await reload()}catch(e){console.error("Admin load failed",e);A.logout();$("#adminView").hidden=true;$("#loginView").hidden=false;toast("Dashboard gagal dimuat: "+(e?.message||"unknown error"),"err");}
}

...
function currentTitle(){return({overview:"Overview",clients:"Klien",projects:"Project",portfolio:"Portfolio",pricing:"Harga",settings:"Pengaturan"})[state.section]||"Overview"}
...
function render(){
  ...
  else if(state.section==="pricing")pricingPage();
  else settingsPage();
}
function overview(){
